...
export default function Header() {
  ...
  const arrowHeight = useTransform(scrollY, [0, 500], ["10px", "400px"]);
  ...
  return (
    <header className="lg:bg-hero bg-heroMobile h-screen bg-cover bg-center bg-no-repeat shadow-heroBoxShadow text-center relative">
      ...
      >
        ...
        />
        <motion.div className="arrow-head border-t-4 border-r-4 border-white  w-4 h-4 transform rotate-[135deg]" />
      </motion.div>
    </header>
  );
}
